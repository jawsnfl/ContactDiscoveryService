...
.L84:
	movq	%r15, %rdi	# p_msg,
	movq	48(%r15), %r12	# p_msg_31->prev, p_prev_msg
	movl	$56, %ecx	#,
	xorl	%edx, %edx	#
	movl	$56, %esi	#,
	call	memset_s@PLT	#
...
.L86:
	...
	jne	.L84	#,
	movl	40(%r15), %eax	# p_msg_31->ab_jid_count, _40
	subq	$8, %rsp	#,
	...
	vpinsrd	$2, %eax, %xmm1, %xmm0	#, _40, tmp158, tmp131
	vmovaps	%xmm0, 8(%rsp)	# tmp131, %sfp
	vmovdqa	8(%rsp), %xmm2	# %sfp, tmp159
	movq	16(%rsp), %rsi	# %sfp, tmp152
	vmovaps	%xmm2, 24(%rsp)	# tmp159, %sfp
	pushq	32(%r15)	# p_msg_31->from
	.cfi_def_cfa_offset 128
	pushq	24(%r15)	# p_msg_31->from
	.cfi_def_cfa_offset 136
	pushq	16(%r15)	# p_msg_31->from
	.cfi_def_cfa_offset 144
	pushq	8(%r15)	# p_msg_31->from
	.cfi_def_cfa_offset 152
	pushq	(%r15)	# p_msg_31->from
